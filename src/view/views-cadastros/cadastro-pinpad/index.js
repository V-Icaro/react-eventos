...
function CadastroPinpad(props){
    ...
    useEffect(() => {
        ...
        firebase.firestore().collection('pinpad').doc(props.match.params.id).get()
            .then(resultado => {
    ...
    function atualizar() {
        ...
        setMsgTipo(null);
                ...
                db.collection('pinpad').doc(props.match.params.id).update({
    ...
    return(
        ...
        {
            msgTipo === 'sucesso' && <Redirect to="/cagece" />
        }

            
        <h3 className="text-center font-weight-bold my-2">{props.match.params.id ? 'Atualizar Fonte' : 'Cadastrar Pinpad'}</h3>
        ...
        <div className="col-12 d-flex">
            ...
            <div className="form-group">
                    <label>Marca</label>
                    <select onChange={(e) => setDescricao(e.target.value)} className="form-control" value={descricao && descricao} required>
                ...
                <div className="form-group">
                    <label>Modelo</label>
                    <select onChange={(e) => setModelo(e.target.value)} className="form-control" value={status && status} required>
                        <option value="" selected disabled hidden>--Selecione um Modelo--</option>
                        <option value="PP100" >PP100</option>
                        <option value="PPC900" >PPC900</option>
                        <option value="PPC920" >PPC920</option>
                    </select>
                </div>
